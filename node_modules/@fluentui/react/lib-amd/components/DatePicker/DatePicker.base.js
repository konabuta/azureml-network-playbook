define(["require", "exports", "tslib", "react", "@fluentui/utilities", "../../Calendar", "@fluentui/date-time-utilities", "../../Callout", "../../TextField", "../../FocusTrapZone", "@fluentui/react-hooks", "./defaults"], function (require, exports, tslib_1, React, utilities_1, Calendar_1, date_time_utilities_1, Callout_1, TextField_1, FocusTrapZone_1, react_hooks_1, defaults_1) {
    ...
    function useSelectedDate(_a) {
        ...
        var _b = react_hooks_1.useControllableValue(value, undefined, function (ev, newValue) { var _a; return (_a = onSelectDate) === null || _a === void 0 ? void 0 : _a(newValue); }), selectedDate = _b[0], setSelectedDateState = _b[1];
    ...
    function useErrorMessage(_a, selectedDate, setSelectedDate, inputValue, isCalendarShown) {
        ...
        return [isCalendarShown ? undefined : errorMessage, validateTextInput, setErrorMessage];
    }
    exports.DatePickerBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
        ...
        var _b = useFocusLogic(), textFieldRef = _b[0], focus = _b[1], preventFocusOpeningPicker = _b[2], preventNextFocusOpeningPicker = _b[3];
        var _c = useCalendarVisibility(props, focus), isCalendarShown = _c[0], setIsCalendarShown = _c[1];
        var _d = useSelectedDate(props), selectedDate = _d[0], formattedDate = _d[1], setSelectedDate = _d[2], setFormattedDate = _d[3];
        var _e = useErrorMessage(props, selectedDate, setSelectedDate, formattedDate, isCalendarShown), errorMessage = _e[0], validateTextInput = _e[1], setErrorMessage = _e[2];
        ...
        return (React.createElement("div", tslib_1.__assign({}, nativeProps, { className: classNames.root, ref: forwardedRef }),
            React.createElement("div", { ref: datePickerDiv, "aria-haspopup": "true", "aria-owns": isCalendarShown ? calloutId : undefined, className: classNames.wrapper },
                React.createElement(TextField_1.TextField, tslib_1.__assign({ role: "combobox", label: label, "aria-expanded": isCalendarShown, ariaLabel: ariaLabel, "aria-controls": isCalendarShown ? calloutId : undefined, required: isRequired, disabled: disabled, errorMessage: errorMessage, placeholder: placeholder, borderless: borderless, value: formattedDate, componentRef: textFieldRef, underlined: underlined, tabIndex: tabIndex, readOnly: !allowTextInput }, textFieldProps, { id: id + '-label', className: utilities_1.css(classNames.textField, textFieldProps && textFieldProps.className), iconProps: tslib_1.__assign(tslib_1.__assign({ iconName: 'Calendar' }, iconProps), { className: utilities_1.css(classNames.icon, iconProps && iconProps.className), onClick: onIconClick }), 
            ...
            isCalendarShown && (React.createElement(Callout_1.Callout, tslib_1.__assign({ id: calloutId, role: "dialog", ariaLabel: pickerAriaLabel, isBeakVisible: false, gapSpace: 0, doNotLayer: false, target: datePickerDiv.current, directionalHint: Callout_1.DirectionalHint.bottomLeftEdge }, calloutProps, { className: utilities_1.css(classNames.callout, calloutProps && calloutProps.className), 
                ...
                React.createElement(FocusTrapZone_1.FocusTrapZone, { isClickableOutsideFocusTrap: true, disableFirstFocus: props.disableAutoFocus },
