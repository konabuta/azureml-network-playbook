define(["require", "exports", "tslib", "react", "../../Utilities", "../../FocusZone", "../../Callout", "../../utilities/selection/index", "../../common/DirectionalHint", "./Suggestions/Suggestions", "./Suggestions/Suggestions.styles", "./Suggestions/SuggestionsController", "./BasePicker.types", "../Autofill/index", "./BasePicker.scss"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, Callout_1, index_1, DirectionalHint_1, Suggestions_1, Suggestions_styles_1, SuggestionsController_1, BasePicker_types_1, index_2, stylesImport) {
    "use strict";
    ...
    var BasePicker = /** @class */ (function (_super) {
        ...
        BasePicker.prototype.render = function () {
            ...
            return (React.createElement("div", { ref: this.root, className: classNames.root, onKeyDown: this.onKeyDown, onBlur: this.onBlur },
                React.createElement(FocusZone_1.FocusZone, { componentRef: this.focusZone, direction: FocusZone_1.FocusZoneDirection.bidirectional, shouldEnterInnerZone: this._shouldFocusZoneEnterInnerZone, role: canAddItems ? 'combobox' : undefined, id: canAddItems ? this._ariaMap.combobox : undefined, "aria-label": canAddItems ? this.props['aria-label'] : undefined, "aria-expanded": canAddItems ? !!this.state.suggestionsVisible : undefined, "aria-owns": canAddItems ? suggestionsAvailable || undefined : undefined, "aria-haspopup": suggestionsAvailable && this.suggestionStore.suggestions.length > 0 ? 'listbox' : 'dialog' },
                    ...
                    React.createElement(index_1.SelectionZone, { selection: this.selection, selectionMode: index_1.SelectionMode.multiple },
                        React.createElement("div", { className: classNames.text, role: "presentation" },
