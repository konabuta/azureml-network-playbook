define(["require", "exports", "tslib", "react", "../../Utilities", "../../Autofill", "./BaseExtendedPicker.scss", "../../FocusZone", "../../Selection"], function (require, exports, tslib_1, React, Utilities_1, Autofill_1, stylesImport, FocusZone_1, Selection_1) {
    ...
    var BaseExtendedPicker = /** @class */ (function (_super) {
        ...
        Object.defineProperty(BaseExtendedPicker.prototype, "items", {
            get: function () {
                var _a, _b, _c, _d;
                return _d = (_c = (_a = this.props.selectedItems, (_a !== null && _a !== void 0 ? _a : (_b = this.selectedItemsList.current) === null || _b === void 0 ? void 0 : _b.items)), (_c !== null && _c !== void 0 ? _c : this.props.defaultSelectedItems)), (_d !== null && _d !== void 0 ? _d : null);
            },
            enumerable: true,
            configurable: true
        });
