        ...
        function CommandBarBase(props) {
            ...
            _this._onRenderData = function (data) {
                return (React.createElement(FocusZone_1.FocusZone, { className: Utilities_1.css(_this._classNames.root), direction: FocusZone_1.FocusZoneDirection.horizontal, role: 'menubar', "aria-label": _this.props.ariaLabel },
                    React.createElement(OverflowSet_1.OverflowSet, { role: "none", componentRef: _this._overflowSet, className: Utilities_1.css(_this._classNames.primarySet), items: data.primaryItems, overflowItems: data.overflowItems.length ? data.overflowItems : undefined, onRenderItem: _this._onRenderItem, onRenderOverflowButton: _this._onRenderOverflowButton }),
                    data.farItems && data.farItems.length > 0 && (React.createElement(OverflowSet_1.OverflowSet, { role: "none", className: Utilities_1.css(_this._classNames.secondarySet), items: data.farItems, onRenderItem: _this._onRenderItem, onRenderOverflowButton: Utilities_1.nullRender }))));
            };
