    ...
    var weeks = React.useMemo(function () {
        ...
        for (var weekIndex = 0; weekIndex < weeksGrid.length; weekIndex++) {
            ...
            var _loop_1 = function (dayIndex) {
                ...
                var dayInfo = __assign(__assign({ onSelected: function () { return onSelectDate(day.originalDate); }, setRef: getSetRefCallback(day.key) }, day), { isMarked: day.isMarked || ((_c = markedDays) === null || _c === void 0 ? void 0 : _c.some(function (markedDay) { return compareDates(day.originalDate, markedDay); })) });
                week.push(dayInfo);
            };
