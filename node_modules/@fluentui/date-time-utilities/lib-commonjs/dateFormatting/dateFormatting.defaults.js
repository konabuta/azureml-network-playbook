 ...
 */
exports.formatDay = function (date) { return date.getDate().toString(); };
/**
 * Format date to a month-day-year string
 * @param date - input date to format
 * @param strings - localized strings
 */
exports.formatMonthDayYear = function (date, strings) {
 ...
 * @param strings - localized strings
 */
exports.formatMonthYear = function (date, strings) {
 ...
 * @param strings - localized strings
 */
exports.formatMonth = function (date, strings) { return strings.months[date.getMonth()]; };
/**
 * Format date to a year string representation
 * @param date - input date to format
 */
exports.formatYear = function (date) { return date.getFullYear().toString(); };
